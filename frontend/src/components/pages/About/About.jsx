...
const About = () => {
  return (
    <div>
      <div className='text-white max-w-4xl mx-auto pt-20 mb-10'>
        <h2 className='text-green-500 font-lora h2 uppercase italic font-extrabold tracking-tighter mb-16 text-center text-4xl'>About</h2>
        <p className='text-lg lg:text-2xl font-round text-center font-montserrat'>
