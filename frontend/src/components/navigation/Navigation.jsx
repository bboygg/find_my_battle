  ...
  return (
    <nav className='bg-slate-50 py-3 relative h-10 sm:h-auto'>
      <ul className={`px-8 sm:static sm:py-0 py-10 bg-inherit fixed top-0 sm:translate-x-0 sm:opacity-100 sm:visible transition
        ...
        {Navigations.map((nav) => {
          return (
            <li key={nav.id} className='sm:inline-block mx-2 py-1 px-px text-lg font-montserrat cursor-pointer font-medium relative after:absolute after:inset-x-0 after:bg-customBlue after:h-0.5 after:top-full
